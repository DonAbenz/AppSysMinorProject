...
foreach($result as $row)
{
	...
	$sub_array[] = '<button type="button" name="delete" id="'.$row["user_id"].'" class="btn btn-danger btn-xs delete" data-status="'.$row["user_status"].'"><span class="glyphicon glyphicon-trash"></span> Delete</button>';
	$data[] = $sub_array;
}
